                        ...
                        <form method="post" action="{{ route('questions.update', $question) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('answers') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea type="text" name="answers" id="input-answers" class="form-control form-control-alternative{{ $errors->has('answers') ? ' is-invalid' : '' }}" placeholder="{{ __('Answers') }}" required>{{ $question->answers }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('score') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="score" required class="form-control">
                                        <option value="1" <?php if($question->score == 1) echo "Selected"; ?> >1</option>
                                        <option value="2" <?php if($question->score == 2) echo "Selected"; ?>>2</option>
                                        <option value="3" <?php if($question->score == 3) echo "Selected"; ?>>3</option>
                                        <option value="4" <?php if($question->score == 4) echo "Selected"; ?>>4</option>
                                        <option value="5" <?php if($question->score == 5) echo "Selected"; ?>>5</option>
                                        <option value="10" <?php if($question->score == 6) echo "Selected"; ?>>10</option>
